...
const Homepage: React.FC<HomepageProps> = ({ currentCycle, journalEntries }) => {
  ...
  const getMoodIcon = (mood: JournalEntry['mood'] | undefined): React.ReactElement | null => {
    switch (mood) {
      case 'happy': return <div className="mood-icon happy">😊</div>;
      case 'energetic': return <div className="mood-icon energetic">⚡</div>;
      case 'neutral': return <div className="mood-icon neutral">😐</div>;
      case 'sad': return <div className="mood-icon sad">😔</div>;
      default: return null;
    }
  };
